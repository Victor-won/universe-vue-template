...
// node_modules/.pnpm/@storybook+addon-a11y@9.0.14_storybook@9.0.14_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  let axe = (await import("./axe-ICH56UBX.js"))?.default || globalThis.axe, { config = {}, options = {} } = input;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-6HF3RRRO.js");
