import {
  require_jsx_runtime
} from "./chunk-SPMEG55G.js";
import {
  I
} from "./chunk-SFIMJ6H3.js";
import {
  require_react_dom
} from "./chunk-MT7SQAXJ.js";
import {
  require_react
} from "./chunk-356KFVLY.js";
import {
  require_global
...
// node_modules/.pnpm/storybook@9.0.14_@testing-library+dom@10.4.0_prettier@3.6.2/node_modules/storybook/dist/components/index.js
var import_react3 = __toESM(require_react());
var import_react4 = __toESM(require_react());
var import_react5 = __toESM(require_react());

// node_modules/.pnpm/storybook@9.0.14_@testing-library+dom@10.4.0_prettier@3.6.2/node_modules/storybook/dist/theming/index.js
...
var nn2;
var Xa2 = C2(() => {
  nn2 = globalThis?.document ? o5.useLayoutEffect : () => {
  };
});
function Pm(e4, t) {
...
function c5(e4, t = []) {
  ...
  function n(i, c) {
    ...
    r = [...r, c];
    function u(d) {
      let { scope: m, children: v, ...R } = d, p = m?.[e4][s] || l, h4 = lt.useMemo(() => R, Object.values(R));
      return (0, import_jsx_runtime3.jsx)(p.Provider, { value: h4, children: v });
    }
    o2(u, "Provider");
    function f(d, m) {
      let v = m?.[e4][s] || l, R = lt.useContext(v);
      if (R) return R;
...
function Ja2() {
  return eo2.navigator?.clipboard ? async (e4) => {
    try {
      await eo2.top?.navigator.clipboard.writeText(e4);
    } catch {
  ...
  if (y) {
    if (i) {
      var F, K2 = x === "y" ? te2 : ne2, T = x === "y" ? le2 : ae2, z2 = x === "y" ? "height" : "width", k2 = y[x], V2 = k2 + h4[K2], D2 = k2 - h4[T], j2 = v ? -L2[z2] / 2 : 0, O = w === ut ? S[z2] : L2[z2], G = w === ut ? -L2[z2] : -S[z2], Ee2 = t.elements.arrow, pe2 = v && Ee2 ? Qt2(Ee2) : {
        ...
        S[z2],
        pe2[z2]
      ), Ot2 = b ? S[z2] / 2 - j2 - Se2 - ue - A.mainAxis : O - Se2 - ue - A.mainAxis, qr2 = b ? -S[z2] / 2 + j2 + Se2 + ve2 + A.mainAxis : G + Se2 + ve2 + A.mainAxis, jo = t.elements.arrow && et2(t.elements.arrow), fp = jo ? x === "y" ? jo.clientTop || 0 : jo.clientLeft || 0 : 0, xl = (F = P2?.[x]) != null ? F : 0, dp = k2 + Ot2 - xl - fp, pp = k2 + qr2 - xl, El = tr(v ? Jt2(V2, dp) : V2, k2, v ? Qe2(D2, pp) : D2);
      y[x] = El, _2[x] = El - k2;
    }
    if (l) {
      var Sl, mp = x === "x" ? te2 : ne2, hp = x === "x" ? le2 : ae2, Bt2 = y[E4], Ln2 = E4 === "y" ? "height" : "width", Cl = Bt2 + h4[mp], Ml = Bt2 - h4[hp], Wo = [te2, ne2].indexOf(g) !== -1, Ll = (Sl = P2?.[E4]) != null ? Sl : 0, Al = Wo ? Cl : Bt2 - S[Ln2] - L2[Ln2] - Ll + A.altAxis, Il = Wo ? Bt2 + S[Ln2] + L2[Ln2] - Ll - A.altAxis : Ml, zl = v && Wo ? jf(Al, Bt2, Il) : tr(v ? Al : Cl, Bt2, v ? Il : Ml);
...
function _d(e4, t) {
  ...
  $2.useEffect(function() {
    ...
    function T(z2) {
      ...
      Bd.getBoundingClientRect = Fd(k2, V2), y?.();
    }
...
function lu(e4, t = []) {
  ...
  function n(i, c) {
    ...
    r = [...r, c];
    let u = o2((d) => {
      let { scope: m, children: v, ...R } = d, p = m?.[e4]?.[s] || l, h4 = $e2.useMemo(() => R, Object.values(R));
      return (0, import_jsx_runtime6.jsx)(p.Provider, { value: h4, children: v });
    }, "Provider");
    u.displayName = i + "Provider";
    function f(d, m) {
      let v = m?.[e4]?.[s] || l, R = $e2.useContext(v);
      if (R) return R;
      if (c !== void 0) return c;
      throw new Error(`\`${d}\` must be used within \`${i}\``);
    }
...
var Ci = Q2.forwardRef(
  (e4, t) => {
    let {
      ...
      onDismiss: l,
      ...s
    } = e4, u = Q2.useContext(Ru), [f, d] = Q2.useState(null), m = f?.ownerDocument ?? globalThis?.document, [, v] = Q2.useState({}), R = Ye2(t, (S) => d(
      S
      ...
      !x || M2 || (a?.(S), c?.(S), S.defaultPrevented || l?.());
    }, m), y = xg((S) => {
      let L2 = S.target;
      [...u.branches].some((A) => A.contains(L2)) || (i?.(S), c?.(S), S.defaultPrevented || l?.());
    }, m);
    return gu((S) => {
...
Rg.displayName = bg;
function yg(e4, t = globalThis?.document) {
...
function xg(e4, t = globalThis?.document) {
...
${t}`);
  ...
  return import_react27.default.createElement(import_react27.Fragment, null, import_react27.default.createElement("span", null, n), ": ", import_react27.default.createElement(
    ...
    (l, s) => l?.name ? import_react27.default.createElement(import_react27.Fragment, { key: s }, "  ", "at ", import_react27.default.createElement(s7, null, l.name), " (", import_react27.default.createElement(wf, null, l.location), ")", import_react27.default.createElement("br", null)) : import_react27.default.createElement(
...
function rp(e4) {
  let t = (0, import_react44.useRef)(), r = (0, import_react44.useRef)(), n = (0, import_react44.useRef)(/* @__PURE__ */ new Map()), { width: a = 1 } = Ro({
    ...
    let { x: m, width: v } = t.current.getBoundingClientRect(), { width: R } = r.current.getBoundingClientRect(), p = l.length ? m + v - R : m + v, h4 = [], g = 0, w = e4.filter((b) => {
      let { id: x } = b, E4 = n.current.get(x), { width: y = 0 } = E4?.getBoundingClientRect() || {}, S = m + g + y > p;
...
//# sourceMappingURL=chunk-C2Y5EJKP.js.map
