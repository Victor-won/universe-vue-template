...
// node_modules/.pnpm/@storybook+vue3@9.0.14_storybook@9.0.14_@testing-library+dom@10.4.0_prettier@3.6.2__vue@3.5.17_typescript@5.8.3_/node_modules/@storybook/vue3/dist/entry-preview-docs.mjs
...
var sourceDecorator = (storyFn, ctx) => {
  ...
  return (0, import_preview_api.useEffect)(() => {
    ...
    shouldSkipSourceCodeGeneration(ctx) || (0, import_preview_api.emitTransformCode)(sourceCode, ctx);
  }), story;
};
